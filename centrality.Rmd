...
plot(g1u, main="Undirected", layout=lay, vertex.size=20, vertex.color="lightskyblue")
plot(g1, main="Directed", layout=lay, vertex.size=20, edge.curved=0.1, vertex.color="lightskyblue")
par(op)
```
...
p <- function(x) {
  op <- par(mar = rep(0, 4))
  plot(gj, vertex.color = pal(x), vertex.label = NA)
  par(op)
}
