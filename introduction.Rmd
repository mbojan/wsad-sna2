...
The tutorials use "igraph" package for social network data representation. Additional functions and datasets are available in package "isnar" (https://github.com/mbojan/isnar). See its GitHub page for installation instructions.
